 ...
 */
router.get('/game/:appId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get('/user/:steamId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
router.get('/price/:appId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const appId = parseInt(req.params.appId);
        if (isNaN(appId)) {
            return res.status(400).json({ error: 'Invalid app ID' });
